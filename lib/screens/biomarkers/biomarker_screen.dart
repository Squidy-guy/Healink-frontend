...
class BiomarkerScreen extends StatelessWidget {
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return InkWell(
                              ...
                              child: _buildBiomarkersWidget(item: item));
                        },
                      ),
              ),
              SizedBox(height: getHeight(30)),
  ...
  Widget _buildBiomarkersWidget({required Map<String, dynamic> item}) {
    return Container(
      padding: EdgeInsets.symmetric(
      ...
      child: Row(
        children: [
          Image.asset(item["image"],
              height: getHeight(48), width: getWidth(48)),
            ...
            children: [
              Text(item["name"],
                  style: AppStyles.blackTextStyle().copyWith(
                      fontWeight: FontWeight.w600, color: kBlackColor)),
