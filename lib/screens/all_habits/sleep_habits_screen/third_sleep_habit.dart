...
class ThirdSleepHabitDetail extends GetView<SleepHabitController> {
  const ThirdSleepHabitDetail({super.key});
                      ...
                      children: [
                        Row(
                          children: [
                            CircleAvatar(
                              radius: 23,
                              backgroundImage: AssetImage(kSleepImage3),
                            ),
                            SizedBox(width: getWidth(12),),
                            Expanded(child: Text("Wake up at an ideal time consistently",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                bulletPoints("Wake up at a consistent time each day and get out of the bedroom within 5 minutes and expose yourself to natural light."),
                          ...
                          SizedBox(height: getHeight(30),),
                          Text("Having consistent sleep-wake timing is crucial for optimal health. Our circadian rhythm regulates hormone activity, body temperature, hunger, digestion, and metabolic processes."
                              "\n\nHaving consistent sleep-wake and light cycling helps to synchronise the brain’s master clock with peripheral clocks (e.g. pancreas, liver)."
                              ...
                              "\n\nInteresting fact: A single sleep cycle is 90 minutes so if you normally get 9 hours, that’s 6 sleep cycles.",
