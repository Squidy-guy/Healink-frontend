...
class FirstSleepHabitDetail extends GetView<SleepHabitController> {
  const FirstSleepHabitDetail({super.key});
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Expanded(child: Text("Avoid caffeine and napping in late afternoon",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                bulletPoints("Avoid having caffeine within 6 hours prior to when you plan on sleeping at night."),
                                bulletPoints("Avoid napping within 6 hours prior to when you plan on sleeping at night."),
                              ],
                            ),
                          ),
                          ...
                          SizedBox(height: getHeight(30),),
                          Text("Caffeine can disrupt our circadian rhythm timing and reduce deep sleep periods and total sleep time significantly, even when consumed up to six hours before bedtime."
