...
class FifthSleepHabitDetail extends GetView<SleepHabitController> {
  const FifthSleepHabitDetail({super.key});
                      ...
                      children: [
                        Row(
                          children: [
                            CircleAvatar(
                              radius: 23,
                              backgroundImage: AssetImage(kSleepImage5),
                            ),
                            SizedBox(width: getWidth(12),),
                            Expanded(child: Text("Calm the mind in bed",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                bulletPoints("Slow breathing."),
                                bulletPoints("Bring your awareness to your breathing and sensations of your body."),
                                bulletPoints("Postpone any intrusive thoughts, worries, brainstorming, or excitement.")
                              ],
                            ),
                          ),
                          ...
                          SizedBox(height: getHeight(30),),
                          Text("While in bed intending to sleep, it is helpful to activate the parasympathetic nervous and still the mind to replace stress, excitement, brainstorming, worry, or rumination."
                              "\n\nActivities to switch off the sympathetic nervous system and activate the parasympathetic nervous system for sleep include breathing techniques such as 4,4,6 breathing, breath counting, slow breathing, the body scan exercise, and feeling the breath with the hand placed on the abdomen. "
                              "\n\nVisualising a relaxing environment or counting to 1000 also helps sleep onset. The point is, there’s plenty of ways to make ourselves fall asleep within 20 minutes of going to bed."
