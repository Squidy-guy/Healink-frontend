...
class FourthSleepHabitDetail extends GetView<SleepHabitController> {
  const FourthSleepHabitDetail({super.key});
                      ...
                      children: [
                        Row(
                          children: [
                            CircleAvatar(
                              radius: 23,
                              backgroundImage: AssetImage(kSleepImage4),
                            ),
                            SizedBox(width: getWidth(12),),
                            Expanded(child: Text("Use the bedroom for sleep only",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                bulletPoints("Get out of the bedroom within 5 minutes of waking up."),
                                bulletPoints("Don’t use a phone, TV, or other entertainment in the bedroom."),
                                bulletPoints("Go to bed only when you feel tired enough that you could fall asleep within 20 minutes or if not leave the bedroom until you feel sleepy again."),
                              ],
                            ),
                          ),
                          ...
                          SizedBox(height: getHeight(30),),
                          Text("Using the bedroom for activities other than sleep (and sexual activity) can make us associate the bed and bedroom with wakefulness and make it harder to sleep."
                              ...
                              "\n\nLying awake in bed for more than around 30 minutes (either after waking in the morning or before sleeping at night) can also inhibit you from associating your bedroom with sleep.", style: AppStyles.blackTextStyle().copyWith(fontSize: 15,fontWeight: FontWeight.w500,),),
