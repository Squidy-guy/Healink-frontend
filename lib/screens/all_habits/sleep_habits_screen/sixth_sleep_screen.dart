...
class SixthSleepHabitDetail extends GetView<SleepHabitController> {
  const SixthSleepHabitDetail({super.key});
                      ...
                      children: [
                        Row(
                          children: [
                            CircleAvatar(
                              radius: 23,
                              backgroundImage: AssetImage(kSleepImage6),
                            ),
                            SizedBox(width: getWidth(12),),
                            Expanded(child: Text("Wind down for sleep",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                bulletPoints("Avoid electronics and stimulating activities like video games, social media, TV, news, and social interactions within 30 minutes prior to when you plan to go to bed."),
                                bulletPoints("Turn down the lights and avoid overhead ceiling lights and blue lights."),
                                bulletPoints("Do less stimulating activities before sleep such as reading, yoga, and writing a to-do list.")
                              ],
                            ),
                          ),
                          ...
                          Obx(() => Wrap(
                            ...
                            children: controller.sixthHabitUpsDowns.map((label) => _buildChip(label['issue'],label)).toList(),
                          )),
                          SizedBox(height: getHeight(30),),
                          Text("Video games, social interactions, news consumption, and social media use within 30 minutes of bedtime typically activate our sympathetic nervous system (fight-or-flight response) and greatly impact sleep onset and quality."
                              ...
                              "\n\nInteresting fact: researchers found that people who wrote a to-do list fell asleep faster than those who wrote about already-accomplished tasks. People also seemed to fall asleep faster the more specifically they wrote their to-do list. Journaling (expressive writing) too seems to relieve stress and aid sleep."
