...
class ThirdNutritionHabitDetail extends GetView<NutritionHabitController> {
  const ThirdNutritionHabitDetail({super.key});
                      ...
                      children: [
                        Row(
                          children: [
                            CircleAvatar(
                              radius: 23,
                              backgroundImage: AssetImage(kNutritionImage3),
                            ),
                            SizedBox(width: getWidth(12),),
                            Expanded(child: Text("Eat a healthy dinner",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
