                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Expanded(child: Text("Avoid junk food, alcohol, and nicotine",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                bulletPoints("Avoid junk food (such as chips, sausages, donuts, sweets, pies, processed meat, etc.)."),
                          ...
                          SizedBox(height: getHeight(30),),
                          Text("Eating processed foods typically contributes to cellular and DNA damage, more rapid ageing, earlier disease onset, and a shorter lifespan. Processed foods tend to have nutrient compositions that are not suitable for human nutritional requirements and metabolism."
