...
class FourthNutritionHabitDetail extends GetView<NutritionHabitController> {
  const FourthNutritionHabitDetail({super.key});
                  ...
                  children: [
                    Row(
                      children: [
                        CircleAvatar(
                          radius: 23,
                          backgroundImage: AssetImage(kNutritionImage4),
                        ),
                        SizedBox(
                          width: getWidth(12),
                        ),
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            bulletPoints(
                                "Avoid junk food (such as chips, sausages, donuts, sweets, pies, processed meat, etc.)."),
                            bulletPoints("Avoid alcohol."),
                            bulletPoints("Avoid nicotine."),
                          ],
                        ),
                      ),
                      SizedBox(
                      ...
                      Obx(() => Wrap(
                            ...
                            children: controller.fourthHabitUpsDowns
                                .map((label) =>
                      ...
                      Text(
                        "Eating processed foods typically contributes to cellular and DNA damage, more rapid ageing, earlier disease onset, and a shorter lifespan. Processed foods tend to have nutrient compositions that are not suitable for human nutritional requirements and metabolism."
                        "\n\nSausages, burger patties, french fries, deep-fried chicken, and pizzas all tend to contain excessive amounts of saturated fats, trans fats, cholesterol, and overall fats, which is associated with hypertension, atherosclerosis, heart attack, and stroke. "
                        "\n\nProcessed red meat such as sausages and bacon are especially detrimental to humans. Just 25g of bacon per week (one rasher) is associated with a 44% increase in risk of dementia. Breakfast cereals and bars, pies, pastries, instant soup, or mass-produced bread tend to also be unbalanced along with processed snacks such as sweets, crisps, chocolate, fruit juice, soft drinks, donuts, pies, milk shakes, cakes, ice cream, cereal bars, or biscuits."
                        "\n\nThese foods are unbalanced in that they typically contain higher amounts of simple sugars, contributing to obesity, hypertension, and diabetes. It is this exclusion of processed and ultra-processed foods that makes the Mediterranean eating pattern supportive of human health.",
                        style: AppStyles.blackTextStyle().copyWith(
                          fontSize: 15,
                      ...
                      SizedBox(height: getHeight(4)),
                      Text(
                        "Nicotine’s toxicity contributes to cancer and cardiovascular diseases. It also degrades the medial habenula (brain region). Smoking is also responsible for nonmalignant respiratory diseases (COPDs: emphysema, chronic bronchitis, and asthma) which contribute to mortality. Exposure to nicotine while pregnant is especially detrimental as it causes damage to the developing brain of the embryo as well as cause transgenerational epigenetic changes."
                        "\n\nThe positive stimulant effects of nicotine are used by many to cope with their environments. People with psychological and psychiatric disorders, and a poor ability to cope, are more likely to smoke than those that are emotionally resilient. "
                        "\n\nPeople who smoke are more likely to use other drugs: alcohol, cannabis, amphetamines, and diet pills. In addition to psychological factors, social factors such as peers and parents contribute to initiating nicotine use. Smoking is the largest preventable cause of death. ",
                        style: AppStyles.blackTextStyle().copyWith(
                          fontSize: 15,
                          fontWeight: FontWeight.w500,
                        ),
