...
class SixthNutritionHabitDetail extends GetView<NutritionHabitController> {
  const SixthNutritionHabitDetail({super.key});
                      ...
                      children: [
                        Row(
                          children: [
                            CircleAvatar(
                              radius: 23,
                              backgroundImage: AssetImage(kNutritionImage6),
                            ),
                            SizedBox(width: getWidth(12),),
                            Expanded(child: Text("Intermittent fasting",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                bulletPoints("Avoid eating late at night."),
                                bulletPoints("Wait at least 12 hours between eating your last meal yesterday and your first meal today."),
                                bulletPoints("Eat at consistent times.")
                                 ],
                            ),
                          ),
                          ...
                          Text("Intermittent fasting, also known as windowed fasting or “16/8” fasting, has proven to be an effective health behavior that increases lifespan, prevents various diseases, and is even better for weight-loss than caloric restriction. Research shows that fasting for 12-16 hours each day supports a healthy metabolism while fasting for less than 10 hours per day is associated with metabolic abnormalities such as obesity and diabetes. Time-restricted feeding has beneficial metabolic effects, reduces insulin resistance, and increases glucose tolerance; helping prevent and manage metabolic syndrome (e.g. obesity and diabetes)."
                              ...
                              "\n\nExample: having the last meal of the day at 5 pm and first meal of the next day at 7 am is a 14 hour fast period."
                              "\n\nInteresting fact: Research suggests that eating 3-5 times per day is best for optimal health."
                              "\n\nInteresting fact: Irregular feeding times disrupts our circadian biology and leaves us susceptible to metabolic abnormalities. So, it’s best to eat at approximately the same time everyday (+/- 30 minutes)."
