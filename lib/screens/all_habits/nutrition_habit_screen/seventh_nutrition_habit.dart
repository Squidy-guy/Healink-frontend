...
class SeventhNutritionHabitDetail extends GetView<NutritionHabitController> {
  const SeventhNutritionHabitDetail({super.key});
                      ...
                      children: [
                        Row(
                          children: [
                            CircleAvatar(
                              radius: 23,
                              backgroundImage: AssetImage(kNutritionImage7),
                            ),
                            SizedBox(width: getWidth(12),),
                            Expanded(child: Text("Adequately hydrate",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                bulletPoints("Carry a water bottle with you throughout the day and drink regularly."),
                                ],
                            ),
                          ),
                          ...
                          SizedBox(height: getHeight(30),),
                          Text("Body water deficits impair the ability to maintain homeostasis during stressors such as sickness, physical exercise, and environmental exposures. Water intake and hydration affects cognitive, emotional, renal, and gastrointestinal function as well as fatigue, skin hydration, and physical performance."
                              ...
                              "\n\nFun fact: around 500 mL of water is typically lost via breathing while sleeping each night. Consider drinking 500 mL of water when you wake up!"
                              "\n\nFun fact: for older adults, the sensation of dehydration and urge to drink is delayed from the actual point they become dehydrated. So for these individuals, a conscious habit to drink is more necessary. Try carrying a water bottle with you wherever you go if you have a poor thirst sensation (or even if you don’t!)"
                              "\n\nFun fact: For extreme exercise (e.g. marathon running) drinking electrolyte beverages (sports drinks) can be helpful in preventing electrolyte deficits (e.g. sodium loss by profuse sweating) but is not necessary for normal exercise."
                              "\n\nFun fact: sometimes our body confuses thirst for hunger, so next time you feel snack-ish, try having some water instead."
                              "\n\nFun fact: Electrolytes are minerals (sodium, potassium, calcium, magnesium, chloride) that we get electrolytes from food and water. They conduct electricity when dissolved in water to help to maintain fluid balance in the body and within our cells. They are essential for controlling fluid balance, regulating blood pressure, muscle contraction (including the heart) and maintaining blood pH."
