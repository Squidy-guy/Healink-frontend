...
class SecondNutritionHabitDetail extends GetView<NutritionHabitController> {
  const SecondNutritionHabitDetail({super.key});
                      ...
                      children: [
                        Row(
                          children: [
                            CircleAvatar(
                              radius: 23,
                              backgroundImage: AssetImage(kNutritionImage2),
                            ),
                            SizedBox(width: getWidth(12),),
                            Expanded(child: Text("Eat a healthy lunch",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
