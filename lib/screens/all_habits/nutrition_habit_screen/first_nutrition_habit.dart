...
class FirstNutritionHabitDetail extends GetView<NutritionHabitController> {
  const FirstNutritionHabitDetail({super.key});
                      ...
                      children: [
                        Row(
                          children: [
                            CircleAvatar(
                              radius: 23,
                              backgroundImage: AssetImage(kNutritionImage1),
                            ),
                            SizedBox(width: getWidth(12),),
                            Expanded(child: Text("Eat a healthy breakfast",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                bulletPoints("Eat a meal made of whole foods (i.e. not refined food) and that has a high variety of different food items.")
                              ],
                            ),
                          ),
                          ...
                          SizedBox(height: getHeight(30),),
                          Text("There is wide scientific consensus that the Mediterranean diet, which is whole-foods and mostly plants, is the optimal diet and is associated with the greatest health outcomes. Compared to a modern western diet, the Mediterranean diet offers low risk of cardiovascular diseases, hypertension, depression, obesity, diabetes, and dementia. "
                              "\n\nEating processed foods typically contributes to cellular and DNA damage, more rapid ageing, earlier disease onset, and a shorter lifespan. Research showed that people who followed the Mediterranean pattern of eating were 46% more likely to age healthily. This pattern of eating includes foods that are high in antioxidants (repairs damage and protects cells) while also excludes foods that are high in oxidants that irreversibly damage (oxidise) DNA and biomolecules. "
                              "\n\nFruit, Vegetables, grains, nuts, seeds, beans, legumes, herbs and spices are the largest portion of the diet. Olive oil, nuts, and fish are favoured over butter and margarine. The preference of animal products is fish and seafood (~2 days per week) with little to no red meat and less poultry, eggs, and dairy."
