...
class FourthStimulationHabitDetail extends GetView<StimulationHabitController> {
  const FourthStimulationHabitDetail({super.key});
                      ...
                      children: [
                        Row(
                          children: [
                            CircleAvatar(
                              radius: 23,
                              backgroundImage: AssetImage(kSimulationImage4),
                            ),
                            SizedBox(width: getWidth(12),),
                            Expanded(child: Text("Analyze and learn",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                bulletPoints("Do any kind of learning that requires analysing new information, problem solving, and investigative thinking such as learning to use new software, taking a course, or learning a musician instrument.")
                              ],
                            ),
                          ),
                          ...
                          SizedBox(height: getHeight(30),),
                          Text("Frequently challenging one’s mind by learning new skills improves various cognitive functions and lowers dementia risk, while repetitive, over-learned and undemanding activities cause the mind to decay from disuse. "
                              "\n\nThe brain needs to be challenged in new ways, life-long, to preserve and improve function. Research shows that working in occupations that require analytical and investigative thinking such as research (analyzing data), is associated with greater cognitive abilities (e.g. processing speed) and a delayed dementia onset."
                              "\n\nFun fact: people who have learned to speak multiple languages benefit from a delayed dementia onset and preserve executive function for longer during aging."
