...
class SecondStimulationHabitDetail extends GetView<StimulationHabitController> {
  const SecondStimulationHabitDetail({super.key});
                      ...
                      children: [
                        Row(
                          children: [
                            CircleAvatar(
                              radius: 23,
                              backgroundImage: AssetImage(kSimulationImage2),
                            ),
                            SizedBox(width: getWidth(12),),
                            Expanded(child: Text("Creative synthesis",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                bulletPoints("Engage in a creative process that requires you to synthesise information to solve a problem such as writing an article or piece of music, or brainstorming and drawing-up plans.")
                              ],
                            ),
                          ),
                          ...
                          SizedBox(height: getHeight(30),),
                          Text( "Humans are highly creative and have a tremendous ability to make connections to combine multiple pieces of information (data) to create something new such as a painting, arrangement of flowers, or a written article). "
                              "\n\nThe brain needs to be challenged in new ways, life-long, to preserve and improve function."
                              ...
                              "\n\nFun fact: researchers compared people’s various leisure-time activities over a 6 year period and found that people doing at least 6 hours per week of creative hobbies had a 60% reduced risk of dementia than those that didn’t. Playing musical instruments reduced dementia risk by 41%. "
                              "\n\nThey also found that people who read news articles had a 182% increased risk of dementia, likely due to it not being an intellectually challenging activity and more of an indulgence."
