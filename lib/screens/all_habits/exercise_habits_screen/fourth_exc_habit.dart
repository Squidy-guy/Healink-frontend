...
class FourthExerciseHabitDetail extends GetView<ExerciseHabitController> {
  const FourthExerciseHabitDetail({super.key});
                      ...
                      children: [
                        Row(
                          children: [
                            CircleAvatar(
                              radius: 23,
                              backgroundImage: AssetImage(kExerciseImage4),
                            ),
                            SizedBox(width: getWidth(12),),
                            Expanded(child: Text("Strength training",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                bulletPoints("Do a strength training session.")
                              ],
                            ),
                          ),
                          ...
                          SizedBox(height: getHeight(30),),
                          Text("Resistance training improves and preserves musculoskeletal health and neuromuscular function. Bone tissue must be exposed to mechanical load greater than that of typical daily activities to stimulate osteogenesis, increasing bone density. Similarly, muscles require increased mechanical load to increase and preserve mass and strength. "
                              "\n\nResistance exercise (e.g. strength training such as weightlifting and calisthenics) is known to greatly aid in preservation of bone and muscle muscle mass, mitigating osteosarcopenia (bone and muscle mass loss)."
                              "\n\nThe Physical Activity Guidelines for Americans is to exercise all major muscle groups at least twice per week (e.g. 2-3 days per week) and allow a muscle at least two days for recovery and repair. "
                              "\n\nRegular strength training is associated with a 46% lower mortality risk in elderly."
                              "\n\nResearch shows that power and strength performance is typically better in the afternoon (peaking at around 4pm), and that the weight loss and cholesterol lowering effects of exercise are also greater around this time. "
                              "\n\nCompound exercises such as squats, bench press, and rows are good for strength training. Strength training also increases sleep drive. Though, exercising too close to bedtime can be detrimental to sleep.",style: AppStyles.blackTextStyle().copyWith(fontSize: 15,fontWeight: FontWeight.w500,),),
