...
class SecondExerciseHabitDetail extends GetView<ExerciseHabitController> {
  const SecondExerciseHabitDetail({super.key});
                      ...
                      children: [
                        Row(
                          children: [
                            CircleAvatar(
                              radius: 23,
                              backgroundImage: AssetImage(kExerciseImage2),
                            ),
                            SizedBox(width: getWidth(12),),
                            Expanded(child: Text("Aerobic exercise - vigorous intensity",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                bulletPoints("Do multiple short bouts of cardiovascular exercise at vigorous-intensity (“vigorous” is about 70% to 85% of your maximum exertion).")
                              ],
                            ),
                          ),
                          ...
                          Text("Humans have not evolved to cope with a sedentary lifestyle. Lack of physical exercise contributes to aging and contributes to various major diseases: heart disease, hypertension, stroke, diabetes, cancer, and Alzheimer's."
                              ...
                              "\n\nInteresting fact: aerobic exercise (especially high intensity) causes the brain to produce more of a growth hormone called BDNF, which enhances neural growth and plasticity, learning and memory, and stimulates neural stem cell development."
