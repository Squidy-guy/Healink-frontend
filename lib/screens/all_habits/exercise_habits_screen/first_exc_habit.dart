...
class FirstExerciseHabitDetail extends GetView<ExerciseHabitController> {
  const FirstExerciseHabitDetail({super.key});
                      ...
                      children: [
                        Row(
                          children: [
                            CircleAvatar(
                              radius: 23,
                              backgroundImage: AssetImage(kExerciseImage1),
                            ),
                            SizedBox(width: getWidth(12),),
                            Expanded(child: Text("Aerobic exercise - moderate intensity",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                bulletPoints("Do 22 minutes of continuous cardiovascular exercise at moderate-intensity (“moderate” is about 50% to 70% of your maximum exertion).")
                              ],
                            ),
                          ),
                          ...
                          SizedBox(height: getHeight(30),),
                          Text("Humans have not evolved to cope with a sedentary lifestyle. Lack of physical exercise contributes to aging and contributes to various major diseases: heart disease, hypertension, stroke, diabetes, cancer, and Alzheimer's."
                              "\n\nGuidelines based on health research are 150 minutes of moderate exercise (such as brisk walking, jogging, and riding) per week for adults (even for elderly people) and 60 minutes per day for children. Most adults and children do not meet these guidelines."
                              "\n\nFor beginners, it’s best to start small and do at least some physical activity and work toward 30 minutes per day at least 5 days per week."
                              ...
                              "\n\nHelpful tip: if you’re having trouble sleeping at night, it might be a sign you’re not getting enough exercise."
                              "\n\nInteresting fact: Physical exercise greatly improves mood and is a highly effective treatment for depression and anxiety. Exercise upregulates various neurotransmitters such as dopamine, serotonin, and endogenous morphine (endorphins)."
