...
class ThirdExerciseHabitDetail extends GetView<ExerciseHabitController> {
  const ThirdExerciseHabitDetail({super.key});
                      ...
                      children: [
                        Row(
                          children: [
                            CircleAvatar(
                              radius: 23,
                              backgroundImage: AssetImage(kExerciseImage3),
                            ),
                            SizedBox(width: getWidth(12),),
                            Expanded(child: Text("Move often",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                bulletPoints("Don’t sit for more than 30 minutes at a time without getting up to move around for at least one minute."),
                                bulletPoints("Don’t be sedentary for more than 9 hours in total per day (excluding regular night time sleep).")
                             ],
                            ),
                          ),
                          ...
                          SizedBox(height: getHeight(30),),
                          Text("Although it is natural to spend much of the day sitting, the issue is that people now tend to spend long continuous periods of time being inactive. Humans have not evolved to cope with a sedentary lifestyle. Sedentary individuals have a 52% higher mortality rate than active individuals. "
                              "\n\nThe solution is to get off the chair regularly to prevent inflammation and get the blood moving to prevent clotting. "
                              ...
                              "\n\nIn addition to avoiding extended periods of sitting, total time sitting per day is another important risk factor. Research shows that sitting for more than 9 hours in total per day is a risk factor for mortality and disease. "
                              "\n\nThe average US adult spends 11-12 hours per day sedentary. Though, bouts of uninterrupted sedentary behavior appear to be more adverse than total sedentary time."
                              "\n\nFun fact: getting up to move regularly also helps deliver blood and oxygen to the brain to support cognitive functioning, making it great to do before a big test, presentation, or meeting.",style: AppStyles.blackTextStyle().copyWith(fontSize: 15,fontWeight: FontWeight.w500,),),
