                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Expanded(child: Text("Self-reflection",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                bulletPoints("If ever you felt negative emotion, you were able to recognize being in that state and what led to it, and deploy rational thought processes in response, rather than reacting without consideration."),
                                bulletPoints("Of an evening, reflect on your day to think about what you did well and what you did not so well, and how you could have been better.")
                              ],
                            ),
                          ),
                          ...
                          SizedBox(height: getHeight(30),),
                          Text("Thoughts, emotions, and perceptions are not accurate depictions of reality. Human thought processes have evolved to increase survival, not necessarily for accuracy and psychological wellbeing. It is common to experience automatic, involuntary thought processes that, if allowed to pass without first being challenged, can be detrimental to emotional wellbeing."
