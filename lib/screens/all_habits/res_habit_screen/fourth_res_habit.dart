                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Expanded(
                            child: Text(
                          "Plan goals and take action daily",
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            bulletPoints(
                                "Have a long-term goal that you personally find meaningful, fulfilling, interesting, and you know you can achieve."),
                            bulletPoints("Picture this goal coming true."),
                            bulletPoints(
                                "Think of the external and internal obstacles that could or currently do stand in the way of you achieving this goal."),
                            bulletPoints(
                                "Develop a specific plan of how you are going to achieve your goals and overcome obstacles."),
                            bulletPoints(
                                "Of an evening, plan your day of tasks for tomorrow that contribute to your goal."),
                            bulletPoints(
                                "Rehearse your day in the morning using your plan created yesterday."),
                            bulletPoints(
                                "Take action daily to work towards your goals.")
                          ],
                        ),
                      ),
                      SizedBox(
