                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Expanded(child: Text("Gratitude",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                bulletPoints("Of an evening, contemplate three things for which you are grateful for."),
                                bulletPoints("Try to cultivate an appreciation for things you experience throughout the day."),
                                ],
                            ),
                          ),
                          ...
                          SizedBox(height: getHeight(30),),
                          Text("Gratitude is a trait of noticing and appreciating the positive in life. Grateful people experience more positive emotions and positive social relationships and are less angry, stressed, anxious, depressed, and vulnerable. They also tend to be more competent and achievement striving. "
