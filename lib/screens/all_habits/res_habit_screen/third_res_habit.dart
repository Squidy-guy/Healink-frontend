                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Expanded(child: Text("Delay gratification",style: AppStyles.whiteTextStyle().copyWith(fontSize: 20,fontWeight: FontWeight.w700,),)),
                          ],
                        ),
                      ],
                    ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                bulletPoints("Practise delaying gratification (such as delaying using your phone for an hour after waking up or waiting 5 seconds before responding to someone in a conversation)."),
                                bulletPoints("Practise stopping an indulgence and substituting it with a healthier or more productive alternative."),
                                bulletPoints("Abstain from destructive pleasures (such as alcohol, drugs, nicotine, junk food) or if addicted, use them less than yesterday."),
                                bulletPoints("Practise voluntary discomfort such as having a cold shower."),
                                ],
                            ),
                          ),
