...
class LessonDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String imagePath =
        Get.arguments['image'] ?? "assets/default_image.png";
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: getHeight(32)),
              Obx(() => CustomButton(
                    title: controller.isClicked.value
                        ? "✓ Added"
                        : "+ Add this habit",
                    onTap: () {
                    ...
                    color: controller.isClicked.value
                        ? kGreenShade2Color
                        : kPrimaryColor,
                    borderColor: controller.isClicked.value
                        ? kGreenShade2Color
                        : kPrimaryColor,
                    shadowColor: controller.isClicked.value
                        ? kGreenShadeColor
                        : kShadowColor,
                    width: getWidth(285),
                    height: getHeight(48),
